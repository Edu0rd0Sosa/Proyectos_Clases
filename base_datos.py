...
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("sosa", 27))
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("yo", 32))
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("eduardo", 17))
conexion.execute("Insert into alumnos(nombre,edad) values(?,?)", ("vera",42))
...
alumno = conexion.execute("select * from alumnos where nombre = 'vera'")
